"""Measure wall time, CPU time, peak memory, and disk footprint of Clean_Raw_Hub.py.
...
TARGET_SCRIPT = SCRIPT_DIR / "Clean_Raw_Hub.py"
...
def main() -> None:
    ...
    print(f"Input footprint  : {folder_size_kb(SCRIPT_DIR / 'input', '*.csv'):.1f} KB")
    print(f"Output footprint : {folder_size_kb(SCRIPT_DIR / 'output', 'Hub*_cleaned.csv'):.1f} KB")
    print(f"Reports footprint: {folder_size_kb(SCRIPT_DIR / 'reports', 'Hub*_report.txt'):.1f} KB")
